		...
		<c:forEach items="${banks}" var="bank">
			<tr class="even">
				<c:if test="${bank.id==currentbank.id}">
					<td bgcolor="red">
					<a href="bank.do?cmd=editer&id=${bank.id}&page=${param.page}">${bank.id}</a></td>
				</c:if>
				<c:if test="${bank.id!=currentbank.id}">
					<td>
					<a href="bank.do?cmd=editer&id=${bank.id}&page=${param.page}">${bank.id}</a>
					</td>
				</c:if>
				<td><a href="bank.do?cmd=supprimer&id=${bank.id}&page=${param.page}">supprimer</a></td>
				<td>${bank.name}</td>
				<td>${bank.address}</td>
				<td>${bank.phone}</td>
				<td>${bank.zipCode}</td>
