...
<div><%=error%></div>
<span class="pageform">
<form action="bank.do"><input name="id" type="hidden"
	value="${currentbank.id}" /> <input name="page" type="hidden"
	value="${param.page}" />
...
<display:table id="currentRow"
	...
	<display:column title="&nbsp">
		<a href="bank.do?cmd=supprimer&id=${currentRow.id}&page=${param.page}">supprimer</a>
	</display:column>
