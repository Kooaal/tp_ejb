...
<input name="id" type="hidden"
	...
	name="currentbank" property="id" /><br />
...
<input name="cmd" type="submit" value="modifier" /> <input name="cmd"
	type="submit" value="ajouter" /> <input name="cmd" type="submit"
	value="suivant" /> <input name="cmd" type="submit" value="precedent" />
<input name="cmd" type="submit" value="dupliquer" /> <input name="cmd"
	type="submit" value="foobar" /> <input name="cmd" type="submit"
	value="annuler" /> <br />
...
<table border="1">
	...
	<tr>
		...
		%> <a href="bank.do?cmd=editer&id=<%=b.getId()%>"><%=b.getId()%></a></td>
		<td><a href="bank.do?cmd=supprimer&id=<%=b.getId()%>">supprimer</a></td>
		<td><%=b.getName()%></td>
		<td><%=b.getAddress()%></td>
		<td><%=b.getPhone()%></td>
		<td><%=b.getZipCode()%></td>
